...
#ifndef PROXIMIIOPROCESSOR_SWIFT_H
#define PROXIMIIOPROCESSOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ProximiioProcessor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface ProximiioLogProcessor : NSObject <ProximiioLocationProcessor>
...
///   </li>
///   <li>
///     currentUserPosition: <code>ProximiioLocation</code> current user position processed by other filters
///   </li>
///   <li>
...
@interface ProximiioLogProcessor (SWIFT_EXTENSION(ProximiioProcessor)) <MFMailComposeViewControllerDelegate>
- (void)mailComposeController:(MFMailComposeViewController * _Nonnull)didFinishWithcontroller didFinishWithResult:(MFMailComposeResult)result error:(NSError * _Nullable)error;
@end
